...
#define ESB_TIMER_IRQ_HANDLER NRFX_CONCAT_3(nrfx_timer_, ESB_TIMER_INSTANCE_NO, _irq_handler)

/** ESB nRF Timer instance */
#define ESB_NRF_TIMER_INSTANCE NRFX_CONCAT_2(NRF_TIMER, ESB_TIMER_INSTANCE_NO)

/** ESB nrfx timer instance. */
#define ESB_NRFX_TIMER_INSTANCE NRFX_TIMER_INSTANCE(ESB_TIMER_INSTANCE_NO)

/** ESB RTC instance number. */
#define ESB_RTC_INSTANCE_NO CONFIG_ESB_SYS_RTC_INSTANCE

#define ESB_RTC_IRQ	    NRFX_CONCAT_3(RTC, ESB_RTC_INSTANCE_NO, _IRQn)
#define ESB_RTC_IRQ_HANDLER NRFX_CONCAT_3(nrfx_rtc_, ESB_RTC_INSTANCE_NO, _irq_handler)

/** ESB nRF Timer instance */
#define ESB_NRF_RTC_INSTANCE NRFX_CONCAT_2(NRF_RTC, ESB_RTC_INSTANCE_NO)

/** ESB nrfx timer instance. */
#define ESB_NRFX_RTC_INSTANCE NRFX_RTC_INSTANCE(ESB_RTC_INSTANCE_NO)
